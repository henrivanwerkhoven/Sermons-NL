...
class sermons_nl_kerktijden{
    ...
    public function __set($key, $value){
        ...
        else wp_die("In sermons_nl_kerktijden::__set: Trying to set non-existing key `".esc_html($key)."`.", "An error occurred");
    }
...
class sermons_nl_kerktijdenpastors{
    ...
    public function __set($key, $value){
        ...
        else wp_die("In sermons_nl_kerktijdenpastors::__set: Trying to set non-existing key `".esc_html($key)."`.", "An error occurred");
    }
